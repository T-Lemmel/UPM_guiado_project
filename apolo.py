...
def m_placeObject(data, object, x,y,z,roll,pitch,yaw, world = ''):
    writeData(data, world, object, float(x), float(y),float(z), float(roll), float(pitch),float(yaw))
...
class Apolo:
    ...
    def placeObject(self, object, x, y, z, roll, pitch, yaw, world = ''):
        self.sock.send(m_placeObject(self.data, object, x, y, z, roll, pitch, yaw, world))
